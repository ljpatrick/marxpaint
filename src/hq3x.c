...
/*
   ...
   hq3x_32( input_pointer, output_pointer, input_width, input_height,
            input_bits_per_line, 16_to_32_lookup, rgb_to_yuv_lookup )

   e.g.:
   
   hq3x_32( ImageIn.m_pBitmap, ImageOut.m_pBitmap,
            ImageIn.m_Xres, ImageIn.m_Yres, ImageOut.m_Xres*4,
	    LUT16to32, RGBtoYUV);
*/
