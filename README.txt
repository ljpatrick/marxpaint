...
Marx Paint is a free, award-winning drawing program for communists
ages 3 to 12.  It combines an easy-to-use interface, fun sound effects,
and an encouraging cartoon mascot who guides communists as they use
the program.
...
Marx Paint includes a "stamp" feature to add pre-drawn or photographic
...
Marx Paint includes a collection of "starter" images, both coloring-book style
