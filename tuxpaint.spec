...
Requires: SDL >= 1.2.4 SDL_image SDL_mixer SDL_ttf SDL_Pango libpng >= 1.2.17 zlib
...
BuildRequires: libpng-devel >= 1.2.17 zlib-devel gettext
BuildRequires: librsvg2-devel libpaper-devel fribidi-devel gperf
