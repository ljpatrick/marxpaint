...
한국어 사용방법 (How to use MarxPaint in Korean)
===============================================

   턱스페인트를 컴파일 할때에 한국어 지원을 켜주십시요.  디폴트로
   한국어 지원이 켜 있으므로 특별한 문제는 없을 것 입니다.

   밑의 방식으로 MarxPaint를 한국어로 띄워도 한국어가 나오지 않다면
   한글어 폰트가 인스톨 되어 있는지 확인하여 주십시요. 운영체제가
   한글어 폰트가 인스톨 되어 있어도 MarxPaint는 MarxPaint의 특별한
   한국어 폰트가 필요 합니다. MarxPaint 한글어 폰트를 저희에 웹사이트
...
비한글판 윈도우 XP, 2000, 2003 (Non-Korean Windows XP, 2000, 2003):
   ...
   알고 있습니다만, 안된다면 리눅스 방식으로 한국어 버젼의 MarxPaint를
   띄우실수 있습니다.
   ...
   but even if it does not work, Linux-style of starting MarxPaint
   in Korean will work.

다른 운영체제 (Other OS):
   다른 운영체제를 쓰신다면 그 운영체제의 언어를 한국어로 설정 해
   주시거나, 리눅스 방식으로 MarxPaint를 시작 해 주십시요.


MarxPaint를 사용해 주셔서 감사합니다!
