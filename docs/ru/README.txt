...
Что такое 'Marx Paint'?

       Marx Paint — свободно распространяемая программа для рисования,
...
Лицензия:
       ...
       Marx Paint — бесплатно распространяемое программное обеспечение с
...
Особенности:
       ...
       Лёгкость в освоение и занимательность
               Marx Paint задуман как программа рисования для детей младшего
       ...
       Расширяемость
               Marx Paint расширяем. Кисти и штампы могут добавляться и
       ...
       Переносимость
               Marx Paint переносим между различными компьютерными
               платформами: Windows, Macintosh, Linux и т.д. Интерфейс при
               этом выглядит одинаково. Marx Paint хорошо работает на старых
     ...
     ----------------------------------------------------------------------
                            ...
                            Использование Marx Paint

Запуск Marx Paint

  Для пользователей Linux/Unix

         Ярлык запуска Marx Paint следует разместить в меню рабочего стола KDE
  ...
  Для пользователей Windows
         ...
         Если Вы устанавливаете Marx Paint на компьютер с использованием
         ...
         можете запустить Marx Paint из раздела "Marx Paint" меню "Пуск" или
         двойным щелчком на иконке рабочего стола.

         Если Вы установили Marx Paint из ZIP-архива или отказались от
         создания ярлыков, для запуска программы следует выполнить двойной
         щелчок по иконке "marxpaint.exe" папке "Marx Paint" на Вашем
         компьютере.

         По умолчанию инсталлятор создаёт папку "Marx Paint" по адресу
         C:\Program Files\, хотя Вы можете задать любое другое
         местоположение.

         Если Вы использовали установку из ZIP-архива папка "Marx Paint" будет
  ...
  Для пользователей Mac OS X
         ...
         Просто выполните двойной щелчок по иконке Marx Paint.

     ----------------------------------------------------------------------

Заставка

       При запуске Marx Paint вначале появляется заставка.
  ...
  Инструменты для рисования
     ...
     ----------------------------------------------------------------------
         ...
         Штамп
                 ...
                 Marx Paint не показывает элементы управления "Зеркало",
  ...
  Прочие элементы управления
     ...
     ----------------------------------------------------------------------
         ...
         Открыть
                 ...
                 "Начальные" изображения
                   ...
                   Кроме рисунков, созданных Вами, Marx Paint предоставляет
     ...
     ----------------------------------------------------------------------
         ...
         Печать
                 ...
                 печати, если только Вы не запустили Marx Paint в
                 полноэкранном режиме. Смотри ниже.
                      ...
                      Запрет печати
                              ...
                              файле Marx Paint, либо использованием
                      ...
                      Команды печати
                              ...
                              Marx Paint осуществляет печать путём генерации
                              ...
                              конфигурационном файле Marx Paint.
                      ...
                      Настройки принтера
                              ...
                              Marx Paint просто печатает на принтере по
                              ...
                              файле Marx Paint ("marxpaint.cfg").
                      ...
                      Настройки диалога печати
                              ...
                              По умолчанию, Marx Paint показывает диалог
                              ...
                              конфигурационном файле Marx Paint. Или Вы можете
     ...
     ----------------------------------------------------------------------
         ...
         Выйти
                 ...
                 Шёлкнув по кнопке "Выйти", закрыв окно Marx Paint'а, или
                 нажав клавишу [Escape], Вы завершите программу Marx Paint.
                 ...
                 при следующем запуске Marx Paint!
                 ...
                 Marx Paint Config. или при запуске Marx Paint из командной
         ...
         Отключение звука
                 ...
                 Marx Paint Config или при запускеMarx Paint из командной
     ...
     ----------------------------------------------------------------------
              ...
              Загрузка рисунков в Marx Paint из внешних источников

     Диалог "Открыть" показывает только рисунки, созданные Вами в
     Marx Paint'е, а как быть, если Вы желаете загрузить иные рисунки или
     фотографии в Marx Paint для редактирования?

     Чтобы сделать это, Вам просто нужно конвертировать рисунок в формат PNG
     (Portable Network Graphic) и поместить его в каталог Marx Paint'а для
     ...
     Linux/Unix
             В скрытой папке ".marxpaint", расположенной в домашней папке
             пользователя: "$(HOME)/.marxpaint/saved/"

С помощью 'marxpaint-import'

       Пользователи Linux и Unix могут применить сценарий оболочки
       "marxpaint-import", который устанавливается при установке Marx Paint.
       Сценарий использует средства NetPBM для конвертации изображения
       ("anytopnm"), подгонки размеров под холст Marx Paint'а ("pnmscale"), и
       ...
       Для использования 'marxpaint-import', просто выполните команду из
       командной строки и укажите имя(имена) файла(ов), которые Вы желаете
       конвертировать.

       Они будут конвертированы и помещены в каталог Marx Paint для
       ...
       Первая строка ("marxpaint-import grandma.jpg") — команда на запуск
       сценария. Следующие две строки — это выход программы.

       Теперь Вы можете запустить Marx Paint, и рисунок будет доступен в
...
Как это сделать вручную
       ...
       Поместите файл PNG в папку Marx Paint для сохранённых рисунков. (Смотри
       выше.)
     ...
     Прочая документация, включённая в дистрибутив Marx Paint (в папке
     "docs"):
       * AUTHORS.txt
       ...
       * OPTIONS.html
         ...
         Marx Paint Config.
       * PNG.txt
         Замечания по созданию изображений в формате PNG для Marx Paint
